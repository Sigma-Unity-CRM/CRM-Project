...
# Updated import_module logic and added comments for directory adjustments
...
# Modified directory reference to ensure it points to correct migration folder
...
# Modified directory reference for down migration to point to correct path
